...
class Styles
{
    ...
    public const COLORS_DARK = "dark";
    public const COLORS_LIGHT = "light";
    public const COLORS_ACCENT = "accent";
    public const COLORS_GOOD = "good";
    public const COLORS_WARNING = "warning";
    public const COLORS_ATTENTION = "attention";
